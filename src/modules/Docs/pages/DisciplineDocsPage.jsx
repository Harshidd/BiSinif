...
const DisciplineDocsPage = () => {
    ...
    const handleConfirm = (data) => {
        // Class is saved by panel
        setStudentName(data.studentName || '')
        setLessonName(data.lessonName || '')
    }

    const category = DOCUMENT_CATEGORIES.DISCIPLINE
    ...
    return (
        <div className="space-y-8 animate-fade-in pb-12">
            ...
            <div className="p-4 bg-blue-50 border border-blue-100 rounded-xl text-blue-800 text-sm flex gap-3">
                ...
                <p>
                    Disiplin tutanakları için sınıf listesindeki öğrencileri otomatik olarak seçip, olay detaylarını girerek resmi evrak formatında çıktı alabilirsiniz.
                </p>
            </div>
